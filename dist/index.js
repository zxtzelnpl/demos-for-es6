! function (e) {
  ...
  function a(e) {
    ...
    return t.e = function (e) {
      return "ready" === u && p("prepare"), m++, k.e(e).then(n, (function (e) {
        throw n(), e
      }));

      function n() {
        m--, "prepare" === u && (w[e] || D(e), 0 === m && 0 === b && E())
      }
    }, t.t = function (e, n) {
  ...
  function j(e) {
    ...
    return t = e, p("check"), (n = 1e4, n = n || 1e4, new Promise((function (e, r) {
      ...
      if (!e) return p(P() ? "ready" : "idle"), null;
      ...
      h = {};
      return D(0), "prepare" === u && 0 === m && 0 === b && E(), n
    }));
    var n
  }
  ...
  function E() {
    ...
    if (f = null, e)
      if (t) Promise.resolve().then((function () {
        ...
        var n = [];
        for (var r in h) Object.prototype.hasOwnProperty.call(h, r) && n.push(g(r));
        e.resolve(n)
      }
  }
    ...
    return function n(t) {
      ...
      function f(e) {
        for (var n = [e], r = {}, t = n.map((function (e) {
          ...
          var o = t.pop(),
            c = o.id,
            i = o.chain;
          if ((l = I[c]) && (!l.hot._selfAccepted || l.hot._selfInvalidated)) {
        ...
        if (Object.prototype.hasOwnProperty.call(h, D)) {
          ...
          switch (E.chain && (A = "\nUpdate propagation: " + E.chain.join(" -> ")), E.type) {
            ...
            case "declined":
              ...
              break;
            case "unaccepted":
              t.onUnaccepted && t.onUnaccepted(E), t.ignoreUnaccepted || (x = new Error("Aborted because " + u + " is not accepted" + A));
              break;
            case "accepted":
              t.onAccepted && t.onAccepted(E), H = !0;
              break;
            case "disposed":
          ...
          if (H)
            for (u in O[u] = h[u], b(w, E.outdatedModules), E.outdatedDependencies) Object.prototype.hasOwnProperty.call(E.outdatedDependencies, u) && (m[u] || (m[u] = []), b(m[u], E.outdatedDependencies[u]));
          M && (b(w, [E.moduleId]), O[u] = j)
        } var S, U = [];
      for (a = 0; a < w.length; a++) u = w[a], I[u] && I[u].hot._selfAccepted && O[u] !== j && !I[u].hot._selfInvalidated && U.push({
        module: u,
        parents: I[u].parents.slice(),
        errorHandler: I[u].hot._selfAccepted
      });
      p("dispose"), Object.keys(_).forEach((function (e) {
        !1 === _[e] && function (e) {
      ...
      for (; T.length > 0;)
        if (u = T.pop(), l = I[u]) {
          ...
          for (c[u] = C, l.hot.active = !1, delete I[u], delete m[u], s = 0; s < l.children.length; s++) {
            var N = I[l.children[s]];
            N && ((S = N.parents.indexOf(u)) >= 0 && N.parents.splice(S, 1))
          }
        } for (u in m)
        if (Object.prototype.hasOwnProperty.call(m, u) && (l = I[u]))
          for (R = m[u], s = 0; s < R.length; s++) q = R[s], (S = l.children.indexOf(q)) >= 0 && l.children.splice(S, 1);
      p("apply"), void 0 !== v && (o = v, v = void 0);
      for (u in h = void 0, O) Object.prototype.hasOwnProperty.call(O, u) && (e[u] = O[u]);
      var X = null;
      for (u in m)
        if (Object.prototype.hasOwnProperty.call(m, u) && (l = I[u])) {
          R = m[u];
          ...
          for (a = 0; a < R.length; a++)
            if (q = R[a], d = l.hot._acceptedDependencies[q]) {
  ...
  function P() {
    if (y) return h || (h = {}), y.forEach(H), y = void 0, !0
  }
  ...
  k.m = e, k.c = I, k.d = function (e, n, r) {
    k.o(e, n) || Object.defineProperty(e, n, {
      enumerable: !0,
      get: r
    })
  }, k.r = function (e) {
    ...
    if (k.r(r), Object.defineProperty(r, "default", {
      ...
      for (var t in e) k.d(r, t, function (n) {
        return e[n]
      }.bind(null, t));
    return r
  }, k.n = function (e) {
  ...
  "./src/index.js": function (e, n, r) {
    "use strict";
    r.r(n);
    console.log("Z——"), console.log(sum(1, 2)), console.log("**********chapters13**********")
  }
});